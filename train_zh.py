...
parser.add_argument('--train-manifest', metavar='DIR',
                    help='path to train manifest csv', default='data/clips-validated_manifest.csv')
parser.add_argument('--val-manifest', metavar='DIR',
                    help='path to validation manifest csv', default='data/clips-test_manifest.csv')
...
parser.add_argument('--model-path', default='models/deepspeech_final_zh.pth',
