...
parser.add_argument("--target-dir", default='Openslr_zh/', type=str, help="Directory to store the dataset.")
...
parser.add_argument('--files-to-process', default="zhCN-test.csv,zhCN-train.csv",
...
def main():
    ...
    for csv_file in args.files_to_process.split(','):
        convert_to_wav(os.path.join(target_unpacked_dir, 'cn_zh_sets/', csv_file),
