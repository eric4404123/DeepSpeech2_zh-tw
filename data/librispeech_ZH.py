...
parser.add_argument("--target-dir", default='LibriSpeech_dataset_zh/', type=str, help="Directory to store the dataset.")
parser.add_argument('--sample-rate', default=16000, type=int, help='Sample rate')
parser.add_argument('--files-to-use', default="data_thchs30.tgz"
                                              , type=str,
