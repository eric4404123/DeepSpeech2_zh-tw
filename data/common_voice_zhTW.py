...
parser.add_argument("--target-dir", default='CommonVoice_dataset_zhTW/', type=str, help="Directory to store the dataset.")
...
parser.add_argument('--files-to-process', default="clips-validated.csv,clips-dev.csv,clips-test.csv,clips-train.csv",
                    type=str, help='list of *.csv file names to process')
args = parser.parse_args()
COMMON_VOICE_URL = "https://voice-prod-bundler-ee1969a6ce8178826482b88e843c335139bd3fb4.s3.amazonaws.com/cv-corpus-3/zh-TW.tar.gz"
...
def main():
    ...
    for csv_file in args.files_to_process.split(','):
        convert_to_wav(os.path.join(target_unpacked_dir, 'cv_zh_corpus/', csv_file),
