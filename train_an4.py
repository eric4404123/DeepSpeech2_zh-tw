...
parser.add_argument('--train-manifest', metavar='DIR',
                    help='path to train manifest csv', default='data/an4_train_manifest.csv')
parser.add_argument('--val-manifest', metavar='DIR',
                    help='path to validation manifest csv', default='data/an4_val_manifest.csv')
...
parser.add_argument('--model-path', default='models/deepspeech_final_an4.pth',
