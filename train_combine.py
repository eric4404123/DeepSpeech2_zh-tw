...
parser.add_argument('--train-manifest', metavar='DIR',
                    help='path to train manifest csv', default='data/an4_zh_com_train_manifest.csv')
parser.add_argument('--val-manifest', metavar='DIR',
                    help='path to validation manifest csv', default='data/an4_zh_com_test_manifest.csv')
...
parser.add_argument('--model-path', default='models/deepspeech_combine_final.pth',
